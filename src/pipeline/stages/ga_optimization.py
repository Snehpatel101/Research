...
def run_ga_optimization(
    ...
    try:
        from stages.stage5_ga_optimize import run_ga_optimization as ga_optimize
        from stages.stage5_ga_optimize import plot_convergence
