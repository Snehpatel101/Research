...
Applies train-only feature scaling to prevent data leakage.
Scalers are fitted ONLY on training data, then applied to val/test sets.
"""
import json
import logging
import traceback
...
def run_feature_scaling(
    ...
    try:
        ...
        # Log sample of features being scaled
        ...
        # Create scaler with robust scaling (handles outliers well)
        ...
        # Save scaler parameters for production inference
