...
Usage:
------
    from src.pipeline._phase1_impl.stages.datasets.adapters import MultiResolution4DAdapter
...
from src.pipeline._phase1_impl.stages.datasets.adapters.utils import (
