...
#
# NOTE: max_features values should match src/core/contracts/model_contract.py MODEL_CONTRACTS.
# MODEL_CONTRACTS is the canonical source of truth for model capabilities.
