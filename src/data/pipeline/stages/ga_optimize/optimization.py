...
def main():
    ...
    logger.info(f"    - MES: {TRANSACTION_COSTS.get('MES', 2.43)} ticks round-trip")
    logger.info(f"    - MGC: {TRANSACTION_COSTS.get('MGC', 3.04)} ticks round-trip")
    logger.info(f"    - MNQ: {TRANSACTION_COSTS.get('MNQ', 6.08)} ticks round-trip")
