...
def process_symbol_final(
    ...
    features_dir = Path('/home/user/Research/data/features')
    ...
    final_dir = Path('/home/user/Research/data/final')
...
def generate_labeling_report(all_results: Dict[str, pd.DataFrame]):
    ...
    # Save report
    report_path = Path('/home/user/Research/results/labeling_report.md')
