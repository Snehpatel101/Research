...
class TestValidateHorizons:
    ...
    def test_valid_horizons(self):
        ...
        from src.pipeline._phase1_impl.config import validate_horizons
...
class TestGetScaledHorizons:
    ...
    def test_same_timeframe_no_change(self):
        ...
        from src.pipeline._phase1_impl.config import get_scaled_horizons
...
class TestAutoScalePurgeEmbargo:
    ...
    def test_default_multipliers_for_h20(self):
        ...
        from src.pipeline._phase1_impl.config import auto_scale_purge_embargo
...
class TestGetDefaultBarrierParamsForHorizon:
    ...
    def test_returns_required_keys(self):
        ...
        from src.pipeline._phase1_impl.config import get_default_barrier_params_for_horizon
...
class TestGetBarrierParams:
    ...
    def test_symbol_specific_params_returned(self):
        ...
        from src.pipeline._phase1_impl.config import get_barrier_params, BARRIER_PARAMS
    ...
    def test_default_params_fallback(self):
        ...
        from src.pipeline._phase1_impl.config import get_barrier_params, BARRIER_PARAMS_DEFAULT
...
class TestHorizonConfig:
    ...
    def test_default_values(self):
        ...
        from src.pipeline._phase1_impl.pipeline_config import HorizonConfig
...
class TestPipelineConfigHorizonIntegration:
    ...
    def test_horizon_config_takes_priority(self):
        ...
        from src.pipeline._phase1_impl.pipeline_config import PipelineConfig, HorizonConfig
...
class TestSupportedHorizonsConfig:
    ...
    def test_supported_horizons_values(self):
        ...
        from src.pipeline._phase1_impl.config import SUPPORTED_HORIZONS
    ...
    def test_horizons_defaults(self):
        ...
        from src.pipeline._phase1_impl.config import HORIZONS
...
class TestTimeframeScalingConfig:
    ...
    def test_timeframe_scaling_keys(self):
        ...
        from src.pipeline._phase1_impl.config import HORIZON_TIMEFRAME_MINUTES
...
class TestHorizonConfigConsistency:
    ...
    def test_phase1_config_imports_from_canonical(self):
        ...
        from src.pipeline._phase1_impl.config import ACTIVE_HORIZONS as phase1
    ...
    def test_phase1_config_exports_label_horizons(self):
        """src.pipeline._phase1_impl.config should export LABEL_HORIZONS."""
        from src.pipeline._phase1_impl.config import LABEL_HORIZONS
    ...
    def test_no_duplicate_definitions(self):
        ...
        import src.pipeline._phase1_impl.config.features as features_module
