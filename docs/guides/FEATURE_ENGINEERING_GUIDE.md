...
**Recommended MTF Strategy:** Strategy 2 (MTF indicators)
**Training timeframe:** 15min
**Source timeframes:** 1min, 5min, 30min, 1h
**Feature count:** 150-200 features

#### Feature Groups

**1. Base Timeframe Features (15min) - 40 features**
...
**Recommended MTF Strategy:** Strategy 1 (single-timeframe)
**Training timeframe:** 15min
**Feature count:** 25-30 features
...
**Recommended MTF Strategy:** Strategy 3 (multi-resolution ingestion) OR Strategy 1
**Training timeframe:** 15min
...
**Recommended MTF Strategy:** Strategy 3 (multi-resolution ingestion)
**Training timeframe:** 15min
**Feature count:** 5 features × 4 timeframes = 20 features
