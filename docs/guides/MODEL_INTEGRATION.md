...
> - `docs/ARCHITECTURE.md` - Target state and current vs intended architecture
> - `docs/implementation/MTF_IMPLEMENTATION_ROADMAP.md` - MTF strategy implementation plan
