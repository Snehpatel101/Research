...
| **MTF** | Base features | +30 MTF indicators | 5 timeframes: 15m, 30m, 1h, 4h, daily (all indicator-derived) |
...
**What's Implemented:**
- MTF indicator generation from 5 higher timeframes (15min, 30min, 1h, 4h, daily)
...
- **Sequence models** → Receive indicators instead of raw bars, potentially suboptimal for temporal learning ⚠️
